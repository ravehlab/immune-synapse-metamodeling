    ...
    for i, y in enumerate(Ys):
        for j, x in enumerate(Xs):
            ...
            current_model = training.get_pm_model4_trained(
                df_model4_trainedTable, observed_Depletion=y, observed_Decaylength=x)
            ...
            prediction_mean[i, j] = current_trace.rv_output_RgRatio_TCRP4.mean()
            prediction_std[i, j] = current_trace.rv_output_RgRatio_TCRP4.std()
