...
submodels[submodelName]['fitFunction'] = \
    'p00 + p10*(x/100.) + p01*(y/100.) + p20*(x/100.)**2 + p11*(x/100.)*(y/100.) + p02*(y/100.)**2'
...
prediction = {}
prediction['n_x'] = 11  # 5  # 21  # number of points in x direction.
...
prediction['n_y'] = 10  # 4  # 20  # number of points in y direction.
