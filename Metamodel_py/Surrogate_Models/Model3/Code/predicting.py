...
def predict(df_model3_trainedTable):
    """
    ...
    for i, y in enumerate(Ys):
        for j, x in enumerate(Xs):
            ...
            current_model = training.get_pm_model3_trained(
                df_model3_trainedTable, observed_Depletion=y, observed_Decaylength=x)
            ...
            prediction_mean[i, j] = current_trace.rv_output_PhosRatio_TCRP3.mean()
            prediction_std[i, j] = current_trace.rv_output_PhosRatio_TCRP3.std()
